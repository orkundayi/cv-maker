...
class _CVPreviewSectionState extends ConsumerState<CVPreviewSection> {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [Theme.of(context).primaryColor.withOpacity(0.03), Colors.transparent],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Choose your template and export your professional CV',
          ...
          if (isMobile) ...[const SizedBox(height: AppConstants.spacingL), _buildExportButton(context, cvData)],
  ...
  Widget _buildModernTemplateSelector(BuildContext context, bool isMobile) {
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(PhosphorIcons.palette(), color: Theme.of(context).primaryColor, size: 18),
            ...
            Container(
              ...
              child: Text(
                '${_availableTemplates.length} templates',
                style: Theme.of(
                  context,
  ...
  Widget _buildResponsiveTemplateGrid(BuildContext context, bool isMobile) {
    if (isMobile) {
      ...
      return Column(children: _availableTemplates.map((template) => _buildTemplateCard(template, true)).toList());
    }
      ...
      builder: (context, constraints) {
        ...
        return Wrap(
          ...
          children: _availableTemplates.map((template) {
            return SizedBox(width: finalCardWidth, child: _buildTemplateCard(template, false));
          }).toList(),
        );
      },
    );
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).dividerColor.withOpacity(0.5),
  ...
  List<String> _getTemplateFeatures(String templateId) {
    switch (templateId) {
      case 'modern_sidebar':
        return ['Modern', 'Sidebar', 'Colorful'];
      case 'minimal_clean':
        return ['Clean', 'Simple', 'ATS-Friendly'];
      case 'professional_corporate':
        return ['Professional', 'Corporate', 'Classic'];
      default:
        return ['Standard'];
    }
  }
  ...
  Widget _buildExportButton(BuildContext context, CVData cvData) {
    return ElevatedButton.icon(
      onPressed: cvData.hasContent && !_isExporting ? () => _exportPdf(context, cvData) : null,
      icon: _isExporting
          ? SizedBox(
              width: 16,
              height: 16,
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                Icon(PhosphorIcons.fileText(PhosphorIconsStyle.bold), color: Theme.of(context).primaryColor, size: 20),
                const SizedBox(width: 8),
                Text(
                  'Live Preview',
                  style: Theme.of(
                    context,
                  ).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).primaryColor),
                ),
                const Spacer(),
                IconButton(
          ...
          Expanded(
            child: Container(
              margin: EdgeInsets.all(isMobile ? AppConstants.spacingS : AppConstants.spacingM),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(8),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(PhosphorIcons.fileText(), size: 48, color: Theme.of(context).primaryColor.withOpacity(0.7)),
            ),
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).primaryColor),
            ),

            const SizedBox(height: AppConstants.spacingS),

            Text(
              'Start filling your information to see the live preview',
              style: Theme.of(
                context,
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                const SizedBox(width: 8),
                const Text('CV exported successfully!'),
              ],
            ),
            backgroundColor: Theme.of(context).primaryColor,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text('Are you sure you want to clear all your CV data? This action cannot be undone.'),
          actions: [
